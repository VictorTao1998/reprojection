...
class MessytableDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        img_L_ir_pattern1 = __get_ir_pattern__(img_L, img_L_no_ir, threshold=0.01)  # [H, W]
        ...
        img_real_L_ir_pattern1 = __get_ir_pattern__(img_real_L, img_real_L_no_ir, threshold=0.02)  # [H, W]
        img_real_R_ir_pattern1 = __get_ir_pattern__(img_real_R, img_real_R_no_ir, threshold=0.02)  # [H, W]
